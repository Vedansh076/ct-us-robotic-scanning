...
# ── Path setup: import from parent project without modifying it ───────────────
_RESEARCH_DIR = Path(__file__).resolve().parent
PROJECT_ROOT = _RESEARCH_DIR.parent          # ct_us/ (original project root)
MODEL_ROOT = PROJECT_ROOT / "model"
sys.path.insert(0, str(PROJECT_ROOT))         # for extract_slice, model.*
sys.path.insert(0, str(_RESEARCH_DIR))        # for registration module
